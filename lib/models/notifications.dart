...
class AppNotification {
  ...
  (type == NotificationType.like && targetPostId != null) ||
  ...
  ///
  /// Only present for `like`, `comment` and `mention`.
  final String? targetPostThumbnail;
  ...
  static List<AppNotification> fromData(
    ...
    return data.map<AppNotification>(
        ...
        return AppNotification(
          ...
          targetPostId: row['video_id'] as String?,
          targetPostThumbnail: row['video_thumbnail_url'] as String?,
  ...
  AppNotification copyWith({
    ...
    return AppNotification(
      ...
      targetPostThumbnail: targetPostThumbnail ?? this.targetPostThumbnail,
